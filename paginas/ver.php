        ...
        <div  id="toda_pagina">
							   ...
							   <nav class="navbar navbar-expand-lg navbar-light" id="nav_inferior">
									...
									<ul class="navbar-nav" >
									   ...
									   <li class="nav-item">
										...
										<li class="nav-item">
											<a class="nav-link" id="links" href="marcarSaida.php"><i class="fa fa-book"></i>S. parque</a>
										</li>
					...
					<div class="container" id="conteudo1">
						<div class="container " id='estetica'>
						          <hr><h4 id="tituloDados">Dados da Entrada<h4><hr>
						</div>		
						  ...
						  <div class="container" id="dados">
						     <form id="form">
								  <div class="form-group" id="email_cont">
									...
									<input type="email" class="form-control" placeholder="Ex: EscrevSeumail@gmail.com" id="email"/>
									<i id="erroMail"></i>
								  </div>
									...
									<div class="form-check" id="pergunta_cont">
									  <input class="form-check-input" type="radio" name="pergunta" id="pergunta" value="Sim"/>
									  <label class="form-check-label" for="exampleRadios1">
										 Sim
									  </label>
									</div>
									<div class="form-check" id="pergunta1_cont">
									  <input class="form-check-input" type="radio" name="pergunta" id="pergunta" value="Nao"/>
                                  ...
                                  <div class="form-group" id="outroDono">
									...
									<input type="text" class="form-control" placeholder="Escreva o nome" id="donoOcasional"/>
