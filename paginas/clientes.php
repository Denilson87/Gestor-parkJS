<DOCTYPE html>
	...
	<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light" id="nav_inferior">
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link" id="links" href="marcarSaida.php"><i class="far fa-abacus"></i>
								S.parque</a>
						</li>
						...
						<li class="nav-item dropdown" id="dadosUser">
							<a class="nav-link dropdown-toggle" data-toggle="dropdown" id="dropdown" href="#"
								role="button"><i class="fa fa-user-circle" aria-hidden="true"></i> Virgilio Mulungo</a>
		...
		<div class="container" id="containerBotao">
			<button type="submit" class="btn btn-success" id="btnCliente" data-toggle="modal"
				data-target="#registoCliente">Novo cliente</button>
		</div>
		...
		<div class="modal fade" id="registoCliente" tabindex="-1" role="dialog"
			aria-labelledby="TituloModalCentralizado" aria-hidden="true">
			<div class="modal-dialog  modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="TituloModalCentralizado"><i class='fas fa-user-edit'></i> Adição do
							novo cliente</h5>
						</center>
						...
						<form id="formulario">
							...
							<div class="form-row">
								...
								<div class="col">
									...
									<input type="number" class="form-control" id="numAlternativo"
										placeholder="N⁰ Alternativo" />
							...
							<div class="container" id="botoes">
								<button type="button" class="btn btn-danger" data-dismiss="modal"
									id="registarCliente">Cancelar</button>
		...
		<div class="modal fade" id="apagarCliente" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog  modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title"><i class='fas fa-trash'></i> Deseja apagar este registo</h5>
						</center>
					</div>
					<div class="modal-body" id="modalCustumerModal">
						<p style="color:red; font-size:16px;">A exclusão deste cliente pode implicar a <b>exclusão do(s)
								seu(s) carro(s)</b>, na lista de carros...<Strong>Deseja Mesmo excluir este
								cliente</strong></p>
						<div class="container" id="botoes">
							<button type="button" class="btn btn-danger" data-dismiss="modal"
								id="registarCliente">Não</button>
		...
		<div class="modal fade" id="sucesso" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog  modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="color:green;"><i class="fa fa-check-square"></i>Apagado com
							sucesso</h5>
						</center>
					</div>
					<div class="modal-body" id="modalCustumerModal">
		...
		<div class="modal fade" id="errorApgar" tabindex="-1" role="dialog">
			<div class="modal-dialog  modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="color:red;"><i class="fa fa-window-close"></i> Apagado com
							sucesso</h5>
						</center>
					</div>
					<div class="modal-body" id="modalCustumerModal">
		...
		<div class="modal fade" id="custumerEdit" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado"
			aria-hidden="true">
			<div class="modal-dialog  modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="color:#FFC107"><i class="fa fa-exclamation-triangle"></i> Editar
							dados do cliente</h5>
						</center>
						...
						<form id="formularioEdit">
							...
							<div class="form-row">
								<div class="col">
									...
									<input type="number" class="form-control" id="numTelEdit"
										placeholder="Numero telemovel" />
									<i class="errosEdit" id="erroNumTelEdit"></i>
								</div>
								<div class="col">
									<label class="subtitulosEdit">Numero Alternativo :</label>
									<input type="number" class="form-control" id="numAlternativoEdit"
										placeholder="N⁰ Alternativo" />
							...
							<div class="col">
								...
								<input type="text" class="form-control" id="funcionarioEdit"
									value="<?php echo $_SESSION['username'];?>" readonly>
							</div><br />
		...
		<div class="modal fade" id="sucessoUpdate" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog  modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="color:green;"><i class="fa fa-check-square"></i>Dados
							actualizados com sucesso</h5>
						</center>
					</div>
					<div class="modal-body" id="modalCustumerModal">
		...
		<div class="modal fade" id="errorActualizar" tabindex="-1" role="dialog">
			<div class="modal-dialog  modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" style="color:red;"><i class="fa fa-window-close"></i>Erro inesperado/h5>
							</center>
					</div>
					<div class="modal-body" id="modalCustumerModal">
						<p style="color:red; font-size:16px;">Ocorreu algum erro inesperado! Por favor volte a tentar
							esta operacao</p>
					</div>
				</div>
			</div>
